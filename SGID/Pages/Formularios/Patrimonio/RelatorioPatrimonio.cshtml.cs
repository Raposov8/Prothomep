    ...
    public class RelatorioPatrimonioModel : PageModel
    {
        ...
        public IActionResult OnPost(string Patrimonio,string Empresa)
        {
            ...
            else
            {
                ...
                var query = ProtheusDenuo.Pa1010s.Where(x => x.DELET != "*" && x.Pa1Msblql != "1" && x.Pa1Status != "B" && x.Pa1Despat == Patrimonio )
                   .Select(x => new
                   {
                       Status = x.Pa1Status == "N" ? "E" : "O",
                       Codigo = x.Pa1Codigo
                ...
                Patrimonios = ProtheusDenuo.Pa1010s.Where(x => x.DELET != "*" && x.Pa1Msblql != "1" && x.Pa1Status != "B").Select(x => x.Pa1Despat).Distinct().ToList();
            }
