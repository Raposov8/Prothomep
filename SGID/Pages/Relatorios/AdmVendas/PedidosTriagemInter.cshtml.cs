...
namespace SGID.Pages.Relatorios.AdmVendas
{
    ...
    [Authorize]
    public class PedidosTriagemInterModel : PageModel
    {
        ...
        public PedidosTriagemInterModel(TOTVSINTERContext protheus,ApplicationDbContext sgid)
        {
            Protheus = protheus;
            SGID = sgid;
        }
        public void OnGet()
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "PedidosTriagemInter",user);
            }
        }
        ...
        public IActionResult OnPostExport()
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "PedidosTriagemInter.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "PedidosTriagemInter Excel", user);
