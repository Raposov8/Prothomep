...
{
    public class BaixaAReceberInterModel : PageModel
    {
        ...
        public BaixaAReceberInterModel(TOTVSINTERContext inter, ApplicationDbContext sgid)
        {
            Protheus = inter;
            SGID = sgid;
        }
        ...
        public IActionResult OnPost(DateTime Datainicio, DateTime Datafim)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "Relatorio Baixa Inter", user);
            }
        ...
        public IActionResult OnPostExport(DateTime Datainicio, DateTime Datafim)
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "RelatorioAReceberBaixaInter.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "Relatorio Baixa Inter Excel", user);
