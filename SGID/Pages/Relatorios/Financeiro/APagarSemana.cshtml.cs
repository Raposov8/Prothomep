...
{
    [Authorize]
    public class APagarSemanaModel : PageModel
    {
        ...
        public APagarSemanaModel(TOTVSDENUOContext protheus, ApplicationDbContext sgid)
        {
            Protheus = protheus;
            SGID = sgid;
        }
        ...
        public IActionResult OnPostAsync(string AnoMes)
        {
            try
            {
                ...
                Relatorios = (from SE20 in Protheus.Se2010s
                              ...
                              join SX50 in Protheus.Sx5010s on new { Chave = SED10.EdXgrdesp, Filial = "03", Tabela = "Z9" } equals new { Chave = SX50.X5Chave, Filial = SX50.X5Filial, Tabela = SX50.X5Tabela }
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "APagarSemana",user);
        ...
        public IActionResult OnPostExport(string AnoMes)
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "APagarSemana.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "APagarSemana Excel", user);
