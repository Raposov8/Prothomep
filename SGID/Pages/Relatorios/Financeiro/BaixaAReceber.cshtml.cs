...
{
    public class BaixaAReceberModel : PageModel
    {
        ...
        public BaixaAReceberModel(TOTVSDENUOContext denuo,ApplicationDbContext sgid)
        {
            Protheus = denuo;
            SGID = sgid;
        }
        ...
        public IActionResult OnPost(DateTime Datainicio,DateTime Datafim)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "Relatorio Baixa Denuo", user);
            }
        ...
        public IActionResult OnPostExport(DateTime Datainicio, DateTime Datafim)
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "RelatorioAReceberBaixaDenuo.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "Relatorio Baixa Denuo Excel", user);
