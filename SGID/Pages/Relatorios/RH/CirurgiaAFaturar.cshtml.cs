...
{
    public class CirurgiaAFaturarModel : PageModel
    {
        ...
        public CirurgiaAFaturarModel(TOTVSDENUOContext context, ApplicationDbContext sgid)
        {
            Protheus = context;
            SGID = sgid;
        }
            ...
            try
            {
                ...
                Relatorio = (from SC5 in Protheus.Sc5010s
                             ...
                             select new RelatorioCirurgiasFaturar
                             {
                                 ...
                                 Emissao = $"{SC5.C5Emissao.Substring(6, 2)}/{SC5.C5Emissao.Substring(4, 2)}/{SC5.C5Emissao.Substring(0, 4)}",
                                 XDtAut = SC5.C5XDtaut,
        ...
        public IActionResult OnPostExport()
        {
            try
            {
                ...
                sheet.Cells[1, 17].Value = "Fabricante";
            ...
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "CirurgiaAFaturarRH Excel", user);
