    ...
    public class CirurgiasValorizadasModel : PageModel
    {
        ...
        public IActionResult OnPostAsync(DateTime DataInicio, DateTime DataFim)
        {
            try
            {
                ...
                if (User.IsInRole("GestorComercial") || User.IsInRole("Admin"))
                {
                    if (user != "TIAGO.FONSECA" && !User.IsInRole("Admin"))
                    {
                        ...
                        Relatorio = (from SC50 in Protheus.Sc5010s
                                     ...
                                     && (SA30.A3Xlogin == user || SA30.A3Xlogsup == user || SA30.A3Xlogsup == user2) && (SC50.C5Utpoper == "F" || SC50.C5Utpoper == "K") && SA10.A1Cgc != "04715053000140" && SA10.A1Cgc != "04715053000220" && SA10.A1Cgc != "01390500000140"
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "CirurgiasValorizadasRH",user);
        ...
        public IActionResult OnPostExport(DateTime DataInicio, DateTime DataFim)
        {
            ...
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "CirurgiasValorizadasRH Excel",user);
