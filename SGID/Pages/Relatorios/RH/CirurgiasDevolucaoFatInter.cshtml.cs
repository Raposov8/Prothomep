...
{
    [Authorize]
    public class CirurgiasDevolucaoFatInterModel : PageModel
    {
        ...
        public CirurgiasDevolucaoFatInterModel(TOTVSINTERContext context, ApplicationDbContext sgid)
        {
            Protheus = context;
            SGID = sgid;
        }
        ...
        public IActionResult OnPostAsync(DateTime DataInicio, DateTime DataFim)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "CirurgiasDevolucaoFatInter", user);
