...
namespace SGID.Pages.Relatorios.RH
{
    ...
    public class CirurgiasFaturadasInterModel : PageModel
    {
        ...
        public IActionResult OnPostAsync(DateTime DataInicio, DateTime DataFim)
        {
            try
            {
                ...
                var query = (from SD20 in Protheus.Sd2010s
                             ...
                             ((int)(object)SD20.D2Cf >= 7102 && (int)(object)SD20.D2Cf <= 7114) || CF.Contains((int)(object)SD20.D2Cf)) && ((int)(object)SD20.D2Emissao >= (int)(object)DataI && (int)(object)SD20.D2Emissao <= (int)(object)DataF)
        ...
        public IActionResult OnPostExport(DateTime DataInicio, DateTime DataFim)
        {
            ...
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "CirurgiasFaturadasInter Excel", user);
