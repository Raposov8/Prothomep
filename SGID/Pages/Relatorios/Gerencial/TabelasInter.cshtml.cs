...
{
    [Authorize]
    public class TabelasInterModel : PageModel
    {
        ...
        public TabelasInterModel(TOTVSINTERContext protheus,ApplicationDbContext sgid)
        {
            Protheus = protheus;
            SGID = sgid;
        }
        ...
        public void OnGet(int Id)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "TabelasInter",user);
            }
        }
        ...
        public IActionResult OnPostExport()
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "TabelaInter.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "TabelaInter Excel", user);
