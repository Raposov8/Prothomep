...
{
    [Authorize]
    public class TabelasProdNCadastradosModel : PageModel
    {
        ...
        public TabelasProdNCadastradosModel(TOTVSDENUOContext protheus,ApplicationDbContext sgid)
        {
            Protheus = protheus;
            SGID = sgid;
        }
        ...
        public IActionResult OnPostAsync(string Tabela)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "TabelasProdNCadastros",user);
        ...
        public IActionResult OnPostExport()
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "TabelaProdNCadastrados.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "TabelaProdNCadastrados Excel", user);
