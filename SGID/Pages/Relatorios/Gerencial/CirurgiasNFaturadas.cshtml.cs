...
{
    [Authorize]
    public class CirurgiasNFaturadasModel : PageModel
    {
        ...
        public CirurgiasNFaturadasModel(TOTVSDENUOContext protheus,ApplicationDbContext sgid)
        {
            Protheus = protheus;
            SGID = sgid;
        }
        public void OnGet()
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "CirurgiasNFaturadas",user);
            }
        }
        ...
        public IActionResult OnPostExport()
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "CirurgiaNFaturadas.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "CirurgiaNFaturadas Excel", user);
