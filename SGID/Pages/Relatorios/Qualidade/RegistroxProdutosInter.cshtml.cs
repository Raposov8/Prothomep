...
{
    [Authorize]
    public class RegistroxProdutosInterModel : PageModel
    {
        ...
        public RegistroxProdutosInterModel(TOTVSINTERContext protheus,ApplicationDbContext sgid)
        {
            Protheus = protheus;
            SGID = sgid;
        }
        ...
        public IActionResult OnPostAsync(string Registro)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "RegistroxProdutosInter",user);
        ...
        public IActionResult OnPostExport(string Registro)
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "RegistroxProdutosInter.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "RegistroxProdutosInter Excel", user);
