...
namespace SGID.Pages.Relatorios.Diretoria
{
    public class CirurgiasValorizadasModel : PageModel
    {
        ...
        public CirurgiasValorizadasModel(TOTVSINTERContext inter,TOTVSDENUOContext denuo, ApplicationDbContext sgid)
        {
            ProtheusInter = inter;
            ProtheusDenuo = denuo;
            SGID = sgid;
        ...
        public void OnGet(string Mes, string Ano, string Empresa)
        {
            try
            {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "CirurgiasValorizadasDiretoria", user);
            }
        }

        public IActionResult OnPostAsync(string Mes,string Ano,string Empresa)
        {
            try
            {
                string DataInicio = $"{Ano}0101";
