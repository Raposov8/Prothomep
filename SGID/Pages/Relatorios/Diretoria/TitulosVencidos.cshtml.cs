    ...
    public class TitulosVencidosModel : PageModel
    {
        ...
        public void OnGet()
        {
            try
            {
                ...
                var query = (from SE10 in Protheus.Se1010s
                             ...
                             join SC50 in Protheus.Sc5010s on new {Filial=SE10.E1Filial,Num= SE10.E1Num } equals new { Filial = SC50.C5Filial, Num = SC50.C5Nota } 
        ...
        public IActionResult OnPostExport(string NReduz, string Tempo, string Revelia)
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "TitulosVencidos.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
