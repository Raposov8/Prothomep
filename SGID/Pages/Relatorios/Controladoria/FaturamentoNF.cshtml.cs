...
{
    [Authorize]
    public class FaturamentoNFModel : PageModel
    {
        ...
        public FaturamentoNFModel( ApplicationDbContext sgid,TOTVSDENUOContext denuo)
        {
            SGID = sgid;
            Protheus = denuo;
        }
        ...
        public IActionResult OnPostAsync(string Ano)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "FaturamentoNF",user);
        ...
        public IActionResult OnPostExport(string Ano)
        {
            try
            {
                ...
                package.Workbook.Worksheets.Add("Faturamento NF");

                var sheet = package.Workbook.Worksheets.SingleOrDefault(x => x.Name == "Faturamento NF");
               ...
               Relatorio.ForEach(Pedido =>
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "FaturamentoNF.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "FaturamentoNF Excel", user);
