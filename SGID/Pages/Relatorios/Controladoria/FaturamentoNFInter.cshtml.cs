    ...
    public class FaturamentoNFInterModel : PageModel
    {
        ...
        public IActionResult OnPostAsync(string Ano)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "FaturamentoNFInter",user);
        ...
        public IActionResult OnPostExport(string Ano)
        {
            try
            {
                ...
                package.Workbook.Worksheets.Add("Faturamento NF Inter");

                var sheet = package.Workbook.Worksheets.SingleOrDefault(x => x.Name == "Faturamento NF Inter");
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "FaturamentoNFInter.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "FaturamentoNFInter Excel", user);
