...
{
    [Authorize]
    public class NFEntradaModel : PageModel
    {
        ...
        public NFEntradaModel(TOTVSDENUOContext context,ApplicationDbContext sgid)
        {
            Protheus = context;
            SGID = sgid;
        }
        ...
        public IActionResult OnPostAsync(string Data)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "NFEntrada",user);
        ...
        public IActionResult OnPostExport()
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "NFEntrada.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "NFEntrada Excel", user);
