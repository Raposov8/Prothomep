...
{
    [Authorize]
    public class SD1Model : PageModel
    {
        ...
        public SD1Model(TOTVSDENUOContext denuo,ApplicationDbContext sgid)
        {
            Protheus = denuo;
            SGID = sgid;
        }
        ...
        public IActionResult OnPost(DateTime DataInicio,DateTime DataFim)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.Log(e, SGID, "SD1 Denuo", user);
        ...
        public IActionResult OnPostExport(DateTime DataInicio, DateTime DataFim)
        {
            try
            {
                ...
                return File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "SD1Denuo.xlsx");
            }
            catch (Exception e)
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "SD1 Denuo Excel", user);
