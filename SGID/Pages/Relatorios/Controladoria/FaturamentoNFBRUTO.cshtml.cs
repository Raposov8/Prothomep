...
namespace SGID.Pages.Relatorios.Controladoria
{
    ...
    public class FaturamentoNFBRUTOModel : PageModel
    {
        ...
        public FaturamentoNFBRUTOModel(ApplicationDbContext sgid,TOTVSDENUOContext denuo)
        {
            SGID = sgid;
            Protheus = denuo;
        }
        ...
        public IActionResult OnPostAsync(string Ano)
        {
            try
            {
                ...
                var queryFaturado = (from SD20 in Protheus.Sd2010s
                                     ...
                                     where SD20.DELET != "*" && SA10.DELET != "*" && SA10.A1Msblql != "1" 
                                     && SB10.DELET != "*" && SF20.DELET != "*" && SC50.DELET != "*" &&
