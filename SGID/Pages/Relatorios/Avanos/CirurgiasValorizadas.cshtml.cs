...
namespace SGID.Pages.Relatorios.Avanos
{
    ...
    public class CirurgiasValorizadasModel : PageModel
    {
        ...
        public CirurgiasValorizadasModel(TOTVSINTERContext context, ApplicationDbContext sgid)
        {
            Protheus = context;
            SGID = sgid;
        }
        ...
        public IActionResult OnPostAsync(DateTime DataInicio, DateTime DataFim)
        {
            try
            {
                ...
                Relatorio = (from SC50 in Protheus.Sc5010s
                             ...
                             && SC50.C5Utpoper == "F" && SA10.A1Cgc != "04715053000140" && SA10.A1Cgc != "04715053000220" && SA10.A1Cgc != "01390500000140" && SB10.B1Ugrpint == "082"
