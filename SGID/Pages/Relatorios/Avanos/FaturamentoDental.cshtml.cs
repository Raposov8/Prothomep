        ...
        public IActionResult OnPostAsync(DateTime DataInicio, DateTime DataFim)
        {
            ...
            try
            {
                ...
                var query = (from SD20 in Protheus.Sd2010s
                             ...
                             && SC60.DELET != "*" && SC50.DELET != "*" && c.DELET != "*" && (((int)(object)SD20.D2Cf >= 5102 && (int)(object)SD20.D2Cf <= 5114)
                             || ((int)(object)SD20.D2Cf >= 6102 && (int)(object)SD20.D2Cf <= 6114) || ((int)(object)SD20.D2Cf >= 7102 && (int)(object)SD20.D2Cf <= 7114)
                             || SD20.D2Cf == "5551" || SD20.D2Cf == "6551" || SD20.D2Cf == "6107" || SD20.D2Cf == "6109") && (int)(object)SD20.D2Emissao >= (int)(object)DataInicio.ToString("yyyy/MM/dd").Replace("/", "")
                             ...
                             && SA10.A1Cgc != "04715053000220" && SA10.A1Cgc != "01390500000140" && SB10.B1Ugrpint == "082"
                ...
                var queryDevolucao = (from SD10 in Protheus.Sd1010s
                                      ...
                                      && CfDevolucao.Contains(SD10.D1Cf) && SC50.C5Xtipopv == "D" && SB10.B1Ugrpint == "082"
