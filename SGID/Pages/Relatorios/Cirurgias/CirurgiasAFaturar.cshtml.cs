...
{
    [Authorize]
    public class CirurgiasAFaturarModel : PageModel
    {
        ...
        public CirurgiasAFaturarModel(TOTVSDENUOContext context,ApplicationDbContext sgid)
        {
            Protheus = context;
            SGID = sgid;
        }
        public void OnGet()
        {
            ...
            {
                string user = User.Identity.Name.Split("@")[0].ToUpper();
                Logger.Log(e, SGID, "CirurgiasAFaturar",user);
            }
        }
