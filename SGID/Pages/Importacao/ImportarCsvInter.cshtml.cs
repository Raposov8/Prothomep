...
{
    public class ImportarCsvInterModel : PageModel
    {
        ...
        public ImportarCsvInterModel(TOTVSINTERContext inter, ApplicationDbContext sgid, IWebHostEnvironment web)
        {
            Protheus = inter;
            SGID = sgid;
            _WEB = web;
        ...
        public IActionResult OnPost(IFormCollection Anexos)
        {
            try
            {
                ...
                {
                    string Caminho = $"{Pasta}/TemporarioInter.csv";
                ...
                FileInfo file = new FileInfo($"{Pasta}/TemporarioInter.csv");
                ...
                using (var reader = new StreamReader($"{Pasta}/TemporarioInter.csv"))
                {
            ...
            catch (FormatException e)
            {
                ...
                Logger.Log(e, SGID, "ImportarCSV Inter", user);
