...
namespace SGID.Pages.DashBoards
{
    ...
    public class DashBoardComercialModel : PageModel
    {
        ...
        public int CirurgiasARevelia { get; set; }
        public double CirurgiasAReveliaValor { get; set; }
                ...
                if (Id == "01")
                {
                    ...
                    else
                    {
                        ...
                        var teste = (from SD10 in ProtheusInter.Sd1010s
                                     ...
                                     && SA30.A3Xunnego != "000008" && (SD10.D1Cf == "1202" || SD10.D1Cf == "2202" || SD10.D1Cf == "3202" || SD10.D1Cf == "1553" || SD10.D1Cf == "2553")
                                     && (int)(object)SD10.D1Dtdigit >= (int)(object)DataInicio && (int)(object)SD10.D1Dtdigit <= (int)(object)DataFim
                                     && (int)(object)SD10.D1Dtdigit >= 20200701 && (SC50.C5Utpoper == "F" || SC50.C5Utpoper == "K") && SA30.A3Xlogin == user
                                     select new
                                     {
                                         SD10.D1Filial,
                                         SD10.D1Fornece,
                        ...
                        FaturadoMes = resultado.Where(x => x.Linha != "000011" && x.Linha != "000012" && x.Faturamento == "F").DistinctBy(x => x.Nf).Count();
                        FaturadoMesValor = resultado.Where(x => x.Linha != "000011" && x.Linha != "000012" && x.Faturamento == "F").Sum(x => x.Total) - RelatorioDev.Where(x => x.Linha != "000011" && x.Linha != "000012" && x.Faturamento == "F").Sum(x => x.Total);

                        CirurgiasARevelia = resultado.Where(x => x.Linha != "000011" && x.Linha != "000012" && x.Faturamento == "K").DistinctBy(x => x.Nf).Count();
                        CirurgiasAReveliaValor = resultado.Where(x => x.Linha != "000011" && x.Linha != "000012" && x.Faturamento == "K").Sum(x => x.Total);
                        //- RelatorioDev.Where(x => x.Linha != "000011" && x.Linha != "000012" && x.Faturamento == "K").Sum(x => x.Total);

                        CirurgiasLicitacoesMes = resultado.Where(x => x.Linha == "000011" || x.Linha == "000012" && x.Faturamento == "F").DistinctBy(x => x.Nf).Count();
                        CirurgiasLicitacoesValor = resultado.Where(x => (x.Linha == "000011" || x.Linha == "000012") && x.Faturamento == "F").Sum(x => x.Total) - RelatorioDev.Where(x => (x.Linha == "000011" || x.Linha == "000012") && x.Faturamento == "F").Sum(x => x.Total);

                        #region BaixaLicitacoes

                        var BaixaLicitacoes = (from SE50 in ProtheusInter.Se5010s
