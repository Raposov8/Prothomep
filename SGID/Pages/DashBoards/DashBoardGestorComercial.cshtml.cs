    ...
    public class DashBoardGestorComercialModel : PageModel
    {
        ...
        public void OnGet(string Id)
        {
            try
            {
                ...
                if (Id == "01")
                {
                    if (user != "TIAGO.FONSECA" && !User.IsInRole("Diretoria") && !User.IsInRole("Admin"))
                    {
                    ...
                    else
                    {
                        ...
                        {
                            #region Tiago
                            var vendedores = ProtheusInter.Sa3010s.Where(x => x.A3Xlogsup != "" && x.DELET != "*" && x.A3Msblql != "1").Select(x => new
                            {
                                x.A3Nome,
                                x.A3Xlogin,
                            }).ToList();
                ...
                else
                {
                    ...
                    else
                    {
                        if (Convert.ToInt32(DataInicio) < 20240228)
                        {
                            ...
                            var vendedores = ProtheusDenuo.Sa3010s.Where(x =>  x.A3Xlogsup != "" && x.DELET != "*").Select(x => new
                            {
                                x.A3Nome,
                                x.A3Xlogin,
                            }).ToList();
