    ...
    public class DashBoardMetasModel : PageModel
    {
        ...
        public JsonResult OnPostFaturados(string Mes, string Ano)
        {
            try
            {
                ...
                Faturamento.Add(new ValoresEmAberto { Nome = "SUB INTER", Valor = BaixaSubInter.Sum(c => c.TotalBaixado) });
                ...
                Faturamento.Add(new ValoresEmAberto { Nome = "SUB DENUO", Valor = BaixaSubDenuo.Sum(c => c.TotalBaixado) });
