...
namespace SGID.Data.Migrations
{
    ...
    [Migration("20220824182222_DadosCirurgiaXAgendamento")]
    partial class DadosCirurgiaXAgendamento
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGID.Data.ViewModel.Agendamentos", b =>
                {
                    ...
                    b.Property<int>("InstrumentadorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGID.Data.ViewModel.Agendamentos", b =>
                {
                    b.HasOne("SGID.Data.ViewModel.Recurso", "Instrumentador")
                        .WithMany()
                        .HasForeignKey("InstrumentadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Instrumentador");
                });
