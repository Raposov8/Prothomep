...
public partial class Sf2010
{
    ...
    public double F2Frete { get; set; }

    public double F2Seguro { get; set; }

    public double F2Icmfret { get; set; }

    public string F2Tipocli { get; set; } = null!;

    public double F2Valbrut { get; set; }

    public double F2Valicm { get; set; }

    public double F2Baseicm { get; set; }

    public double F2Valipi { get; set; }

    public double F2Baseipi { get; set; }

    public double F2Valmerc { get; set; }

    public string F2Nfori { get; set; } = null!;

    public double F2Descont { get; set; }
    ...
    public double F2Volume1 { get; set; }

    public double F2Volume2 { get; set; }

    public double F2Volume3 { get; set; }

    public double F2Volume4 { get; set; }

    public double F2Icmsret { get; set; }

    public double F2Pliqui { get; set; }

    public double F2Pbruto { get; set; }
    ...
    public double F2Fatorb0 { get; set; }

    public string F2Dtbase1 { get; set; } = null!;

    public double F2Fatorb1 { get; set; }

    public double F2Variac { get; set; }

    public double F2Baseiss { get; set; }

    public string F2Filial { get; set; } = null!;

    public double F2Valiss { get; set; }

    public double F2Valfat { get; set; }

    public double F2Contsoc { get; set; }

    public double F2Bricms { get; set; }

    public double F2Fretaut { get; set; }

    public double F2Icmauto { get; set; }

    public double F2Despesa { get; set; }
    ...
    public double F2Basimp1 { get; set; }

    public double F2Basimp2 { get; set; }

    public double F2Basimp3 { get; set; }

    public double F2Basimp4 { get; set; }

    public double F2Basimp5 { get; set; }

    public double F2Basimp6 { get; set; }

    public double F2Valimp1 { get; set; }

    public double F2Valimp2 { get; set; }

    public double F2Valimp3 { get; set; }

    public double F2Valimp4 { get; set; }

    public double F2Valimp5 { get; set; }

    public double F2Valimp6 { get; set; }

    public string F2Ordpago { get; set; } = null!;

    public string F2Nfcupom { get; set; } = null!;

    public double F2Valinss { get; set; }

    public string F2Hora { get; set; } = null!;

    public double F2Moeda { get; set; }

    public string F2Regiao { get; set; } = null!;

    public double F2Valcsll { get; set; }

    public double F2Valcofi { get; set; }

    public double F2Valpis { get; set; }

    public string F2Lote { get; set; } = null!;

    public double F2Txmoeda { get; set; }

    public double F2Valirrf { get; set; }

    public string F2Carga { get; set; } = null!;

    public string F2Seqcar { get; set; } = null!;

    public double F2Baseins { get; set; }

    public string F2Pedpend { get; set; } = null!;

    public double F2Desccab { get; set; }
    ...
    public double F2Icmsdif { get; set; }

    public double F2Valacrs { get; set; }
    ...
    public double F2Baseps3 { get; set; }

    public double F2Valps3 { get; set; }

    public double F2Basecf3 { get; set; }

    public double F2Valcf3 { get; set; }

    public string F2Nfeletr { get; set; } = null!;

    public string F2Eminfe { get; set; } = null!;

    public double F2Crednfe { get; set; }

    public string F2Codnfe { get; set; } = null!;

    public double F2VlrFrt { get; set; }
    ...
    public double F2Valfds { get; set; }

    public string F2Client { get; set; } = null!;

    public string F2Lojent { get; set; } = null!;

    public double F2Estcred { get; set; }

    public double F2Baseirr { get; set; }

    public double F2Basetst { get; set; }

    public double F2Valtst { get; set; }

    public string F2Flagdev { get; set; } = null!;

    public double F2Xcomis1 { get; set; }

    public double F2Xcomis2 { get; set; }

    public double F2Xcomis3 { get; set; }

    public double F2Xcomis4 { get; set; }
    ...
    public double F2Vlsenar { get; set; }

    public double F2Valfab { get; set; }

    public double F2Valfac { get; set; }

    public double F2Valfet { get; set; }

    public string F2Hornfe { get; set; } = null!;

    public double F2Basefun { get; set; }

    public double F2Desczfr { get; set; }

    public double F2Valina { get; set; }

    public double F2Baseina { get; set; }

    public double F2Baspis { get; set; }

    public double F2Bascofi { get; set; }

    public double F2Bascsll { get; set; }
    ...
    public double F2Vreint { get; set; }

    public double F2Bsrein { get; set; }
    ...
    public double F2Refmoed { get; set; }

    public double F2Reftaxa { get; set; }
    ...
    public double F2Totimp { get; set; }
    ...
    public double F2Totfed { get; set; }

    public double F2Totest { get; set; }

    public double F2Totmun { get; set; }

    public double F2Vlcpm { get; set; }

    public double F2Basecpm { get; set; }

    public double F2Valfmp { get; set; }

    public double F2Basefmp { get; set; }

    public double F2Valfmd { get; set; }
    ...
    public double F2Valfase { get; set; }

    public double F2Valfund { get; set; }

    public double F2Valima { get; set; }
    ...
    public string F2Xnumage { get; set; } = null!;

    public string F2Xnumpro { get; set; } = null!;

    public double F2Bsfccmp { get; set; }

    public string F2Cliret { get; set; } = null!;

    public double F2Basfecp { get; set; }

    public double F2Bsfcpst { get; set; }
    ...
    public string? F2Coda1u { get; set; }
}
